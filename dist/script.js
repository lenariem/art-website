...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var fileNameArr = item.files[0].name.split('.'); // ['nature', 'jpg]

      fileNameArr[0].length > 6 ? dots = '...' : dots = '.';
      var name = fileNameArr[0].substring(0, 6) + dots + fileNameArr[1];
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusMessage.appendChild(textMessage); //Object with all inputs values
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    document.addEventListener('keydown', function (e) {
      return e.key === "Escape" ? modal.style.display = "none" : false;
    });
  ...
  function calcScroll() {
    ...
    document.body.appendChild(div); //whole width - content width(not includes scroll)
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreStyles); //only with js and css
...
var sliders = function sliders(slides, direction, prev, next) {
  var items = document.querySelectorAll(slides); //active slide
  ...
  activateAnimation(); //to stop auto switch in slider if user point on slider
